...
class Crossbeams::LabelTest < Minitest::Test
  ...
  def test_basic
    ...
    assert_equal 'The label', html_dom_text_value_by_id(s)
  end
  ...
  def test_time_formats
    ...
    assert_equal '2020-01-01 11:34:21 +0200', html_dom_text_value_by_id(s)

    s = simple_label_render(time, format: :without_timezone)
    assert_equal '2020-01-01 11:34:21', html_dom_text_value_by_id(s)

    s = simple_label_render(time, format: :without_timezone_or_seconds)
    assert_equal '2020-01-01 11:34', html_dom_text_value_by_id(s)
  ...
  def test_preformat
    ...
    assert_equal str, html_dom_text_value_by_id(s)
  ...
  def test_hidden
    ...
    assert_equal str, html_dom_text_value_by_id(s, 'lbl_test_form_the_test_field')
