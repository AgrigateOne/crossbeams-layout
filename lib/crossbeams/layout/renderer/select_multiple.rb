...
module Crossbeams
  module Layout
    module Renderer
      ...
      class SelectMultiple < Base # rubocop:disable Metrics/ClassLength
        ...
        def build_options(list, selected = [], disabled_option = nil)
          if list.is_a?(Hash)
