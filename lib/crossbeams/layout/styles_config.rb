...
module Crossbeams
  module Layout
    ...
    class StylesConfig
      ...
      setting :button_for_collection, default: 'text-3xl flex items-center justify-center basis-1/3 sm:basis-1/4 md:basis-1/6 aspect-square rounded-3xl border-2 border-$:secondary_bg$ min-w-[2.75rem] px-4 py-2 outline-none select-none cursor-pointer font-normal text-$:secondary_colour$ bg-$:secondary_bg$ active:bg-ocean-700 active:border-$:primary_h_colour$ hover:text-$:primary_h_colour$ hover:bg-$:secondary_h_bg$ focus-visible:ring focus-visible:ring-offset-white focus-visible:ring-offset-2 focus-visible:ring-ocean-500'
      ...
      setting :table_div, default: 'border border-slate-300 rounded-lg overflow-scroll'
      setting :table_div_no_b, default: 'overflow-scroll'
      setting :table, default: 'w-full h-full border-collapse overflow-auto'
      setting :table_row_odd, default: '$:hover_row$ border-b border-slate-300'
      setting :table_row_even, default: '$:hover_row$ bg-slate-50 border-b border-slate-300'
      setting :table_row_odd_last, default: '$:hover_row$'
      setting :table_row_even_last, default: '$:hover_row$ bg-slate-50'
      # setting :table_th, default: 'p-5 py-2 border-t border-b border-slate-300 text-slate-800 font-semibold'
      setting :table_th, default: 'p-5 py-2 text-slate-800 font-semibold'
      ...
      setting :table_td, default: 'px-5 py-2 border-r border-slate-300'
      setting :table_td_last, default: 'px-5 py-2'
      ...
      setting :rmd_table_div, default: 'w-full mt-1 border border-slate-300 rounded-lg overflow-scroll'
      setting :rmd_table, default: 'w-full h-full border-collapse overflow-hidden'
