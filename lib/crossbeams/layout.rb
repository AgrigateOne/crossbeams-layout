...
require 'crossbeams/layout/chart'
require 'crossbeams/layout/collection'
require 'crossbeams/layout/column'
require 'crossbeams/layout/download_dashboard_button'
...
require 'crossbeams/layout/filter'
...
module Crossbeams
  ...
  module Layout
    ...
    class DeveloperDocumentation
      DOCUMENTATION_FILES = %w[page_layout.adoc non_field_renderers.adoc field_renderers.adoc dashboards_lanes.adoc dashboards_charts.adoc].freeze
